#!/bin/bash
# ===================================================================================
#   Daury's Live Wallpaper Manager (v13.2 - Ultra Low-Power Test)
#
#   This version implements extremely aggressive video optimization to diagnose
#   the root cause of high resource usage.
# ===================================================================================

# --- SCRIPT CONFIGURATION (ULTRA LOW-POWER) ---
REQUIRED_CMDS=("mpvpaper" "jq" "ffmpeg" "notify-send")
OPTIMIZE_RESOLUTION="1920x1080"
OPTIMIZE_FRAMERATE="15"      # Reduced to 15 FPS
OPTIMIZE_QUALITY_CRF="35"      # Increased compression (35 is very high)
OPTIMIZE_BITRATE="500k"      # Target bitrate: 500 Kilobits/s
OPTIMIZE_MAXRATE="750k"      # Max bitrate
OPTIMIZE_BUFSIZE="1M"        # Buffer size
OPTIMIZED_CACHE_DIR_NAME="optimized_ultra_low" # New cache for this test
